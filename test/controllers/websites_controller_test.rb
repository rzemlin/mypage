...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference("Website.count") do
      post websites_url, params: { website: { body: @website.body, link: @website.link, title: @website.title } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { body: @website.body, link: @website.link, title: @website.title } }
